...
This code creates a scene, a camera, eyes which positioned differently and always look at the mouse wherever the mouse is. It adds the geometries to the scene. It then creates a WebGL renderer for the scene and camera, and it adds that viewport to the document.body element. Finally, it animates the geometries within the scene for the camera.
