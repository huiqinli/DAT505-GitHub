...
This code creates a scene, a camera, a world full of whales, and they can change colors when clicked by a mouse. It adds the geometries to the scene. It then creates a WebGL renderer for the scene and camera, and it adds that viewport to the document.body element. Finally, it animates the OBJ within the scene for the camera.
