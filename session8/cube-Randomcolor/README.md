...
This code creates a scene, a camera, geometries changing colors in reaction to the mouse clicking. It adds the geometries to the scene. It then creates a WebGL renderer for the scene and camera, and it adds that viewport to the document.body element. Finally, it animates the geometries within the scene for the camera.
