...
This code creates a scene, a camera, lights, an array of geometry and different parts are given different colors. Orders are given for each geometry to rotate, and it adds the geometries to the scene. It then creates a WebGL renderer for the scene and camera, and it adds that viewport to the document.body element. Finally, it renders the array within the scene for the camera.
...
`set the parameter of different parts of meshes
`
